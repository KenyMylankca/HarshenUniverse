...
public class ModelSoulShooter extends ModelBiped
{
    public ModelSoulShooter()
    {
        this(0.0F, false);
    }

    public ModelSoulShooter(float modelSize, boolean p_i46303_2_)
    {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime)
    {
        ...
        if (((EntitySoulShooter)entitylivingbaseIn).isSwingingArms())
        {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        EntitySoulShooter soulshooter = (EntitySoulShooter)entityIn;

        if (soulshooter.isSwingingArms() && (itemstack.isEmpty() || itemstack.getItem() != HarshenItems.SOUL_RIPPER_BOW))
        {
