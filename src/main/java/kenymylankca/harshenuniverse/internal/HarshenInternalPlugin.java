...
{		
	...
	public void register(IHarshenRegistry registry) 
	{
		...
		registry.registerLightningRecipe(new ItemStack(Items.NETHER_STAR), new HarshenStack(new ItemStack(HarshenItems.ITIUM)), new HarshenStack(new ItemStack(HarshenItems.POWDER_OF_HERETISM)),
		...
		registry.registerLightningRecipe(new ItemStack(HarshenItems.AQUA_EARRING), new HarshenStack(new ItemStack(HarshenItems.RITUAL_CRYSTAL, 1, 1)), new HarshenStack(new ItemStack(Items.PRISMARINE_CRYSTALS)),
